    ...
    class TestParser < Minitest::Test
      ...
      def test_parse
        @parser.parse.each do |spec|
          assert_instance_of SC::Spec, spec
        end
      end
...
RAW_SPEC
        ...
        assert_instance_of SC::Spec, spec
        assert_instance_of SC::Spec::Signature, spec.signature
        spec.rules.each do |rule|
          assert_instance_of SC::Spec::Rule, rule
        end
...
RAW_SPEC_RULE
        ...
        assert_instance_of SC::Spec::Rule, spec_rule
...
RAW_SPEC_SIGNATURE
        ...
        assert_instance_of SC::Spec::Signature, spec_signature
